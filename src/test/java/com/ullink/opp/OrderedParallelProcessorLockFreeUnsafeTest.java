...
public class OrderedParallelProcessorLockFreeUnsafeTest
{
    ...
    public long bench() throws Exception {
        ...
        final OrderedParallelProcessorLockFreeUnsafe seqx = new OrderedParallelProcessorLockFreeUnsafe(1024);

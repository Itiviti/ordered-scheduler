...
public class OrderedParallelProcessorLowLevel
{
    ...
    public OrderedParallelProcessorLowLevel(int nSlot, ExceptionHandler exceptionHandler)
    {
        // Next power of 2
    ...
    public OrderedParallelProcessorLowLevel(int nSlot)
    {
